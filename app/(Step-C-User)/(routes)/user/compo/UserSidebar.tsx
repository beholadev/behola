...
const UserSidebar = () => {
  ...
  return (
    <ScrollArea
      className={cn(
        "space-y-2 py-2 flex flex-1 h-full transition duration-600 bg-[#111827] text-white",
          ...
          <div className="pt-1 mt-2">
            {routes.map((route) => (
              <Link
                ...
                key={route.href}
                className={cn(
                  "text-sm group flex p-1 w-full justify-start font-medium tracking-widest cursor-pointer hover:text-white hover:bg-white/10 rounded-lg transition",
                  pathname === route.href
